...
down_revision: str | None = "20260819_create_admins_table"
...
TEST_ADMIN_PASSWORD_HASH = (
    "$2b$12$6ibMmIa5vY9GUoTYrOneBeveiRX3k70RfuUiwNZv5HZZ2/5.qFdtC"
)
...
def downgrade() -> None:
    op.execute(
        sa.text("DELETE FROM admins WHERE id = :admin_id").bindparams(
